...
import websiteResume from "../assets/images/website-resume.svg";
    ...
    <div>
      ...
      <Content className="/">
        <p>
          ...
          the extra mile. Interested in graphic and web design, web development,
          e-commerce, nutrition, fitness, nature and travelling.
        </p>
        <p>
          <a href="../components/resume" alt="/">
            Check out my resume
          </a>
        </p>
      </Content>
